      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <h3 className="text-xl font-bold mb-4">Star Canada International</h3>
            <p className="text-gray-400 mb-4">
              Global trading company specializing in metal scrap and industrial equipment,
        ...
        <div className="pt-8 mt-8 border-t border-gray-800 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} Star Canada International. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
