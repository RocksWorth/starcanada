  ...
  return (
    <main className="container mx-auto px-6 py-16">
      ...
      <section className="mb-16">
        ...
        />
        <div className="mt-8">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-800">Construction Machinery & Industrial Equipment</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
            <div className="bg-blue-50 p-6 rounded-xl">
              <h3 className="font-bold text-blue-800 mb-2">Heavy Equipment</h3>
              <p className="text-gray-700">Excavators, bulldozers, loaders, cranes, and earthmoving machinery</p>
            </div>
            <div className="bg-blue-50 p-6 rounded-xl">
              <h3 className="font-bold text-blue-800 mb-2">Engines & Generators</h3>
              <p className="text-gray-700">Diesel engines, generators, power units, and industrial motors</p>
            </div>
            <div className="bg-blue-50 p-6 rounded-xl">
              <h3 className="font-bold text-blue-800 mb-2">Parts & Supplies</h3>
              <p className="text-gray-700">Hydraulic components, filters, belts, and maintenance supplies</p>
            </div>
          </div>
      ...
      <section className="mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white p-8 rounded-xl shadow-lg">
            <h3 className="text-2xl font-bold text-gray-800 mb-4">Construction Machinery</h3>
            ...
            <p className="text-sm text-gray-600">All equipment includes condition reports, service history, and operational testing</p>
          </div>
          
          <div className="bg-white p-8 rounded-xl shadow-lg">
            <h3 className="text-2xl font-bold text-gray-800 mb-4">Power & Industrial</h3>
            <ul className="space-y-2 text-gray-700 mb-6">
            ...
            <p className="text-sm text-gray-600">Tested and certified equipment with performance documentation</p>
          </div>
        </div>
      </section>
      ...
      <section className="mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="text-center p-6">
            ...
            <h3 className="font-bold text-gray-800 mb-2">Verified Condition</h3>
            <p className="text-gray-600">Every piece of equipment is inspected, tested, and documented with photos and videos</p>
          </div>
          ...
          <div className="text-center p-6">
            ...
            <p className="text-gray-600">Direct sourcing from suppliers eliminates middleman costs and reduces your total investment</p>
          </div>
          ...
          <div className="text-center p-6">
            ...
            <h3 className="font-bold text-gray-800 mb-2">Global Logistics</h3>
            <p className="text-gray-600">Complete shipping, customs, and delivery coordination to your job site or facility</p>
          </div>
        </div>
      </section>
